...
def func_read(cmd: str, ser):
    ...
    match cmd:
        ...
        case "frame_mult":
            ...
            text_result = "========================================\n"
            text_result += f'  >>> Frame Multiplication: X{data[1]} <<<\n'
            text_result += "========================================"
            print(f'{text_result}')

        case "frame_state":
            response = send_and_get(cmd_array, 13, ser)
        ...
        case _:
            ...
            if response[1] == 0x4 and response[2] in (0x81, 0x83, 0x87, 0x8B):
...
def func_write(cmd: str, ser, value: str | None = None):
    ...
    if cmd in ["heat1_on","heat2_on","heat1_off","heat2_off","focus","zoom","diaph"]:
        ...
        case "back":
            ...
            try:
                ...
                if index == 4:
                    ...
                    raise Exception('Some problem with a console mode')
